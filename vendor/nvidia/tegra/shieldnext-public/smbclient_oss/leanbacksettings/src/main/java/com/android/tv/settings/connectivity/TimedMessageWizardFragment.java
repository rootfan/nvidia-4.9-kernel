...
public class TimedMessageWizardFragment extends MessageWizardFragment {
    ...
    public static TimedMessageWizardFragment newInstance(String title) {
        return newInstance(title, null, DEFAULT_TIME_OUT_MS);
    }

    public static TimedMessageWizardFragment newInstance(String title, String desc) {
        return newInstance(title, desc, DEFAULT_TIME_OUT_MS);
    }


    public static TimedMessageWizardFragment newInstance(String title, String desc, int durationMs) {
        TimedMessageWizardFragment fragment = new TimedMessageWizardFragment();
        Bundle args = new Bundle();
        args.putInt(KEY_TIME_OUT_DURATION, durationMs);
        MessageWizardFragment.addArguments(args, title, desc, false);
