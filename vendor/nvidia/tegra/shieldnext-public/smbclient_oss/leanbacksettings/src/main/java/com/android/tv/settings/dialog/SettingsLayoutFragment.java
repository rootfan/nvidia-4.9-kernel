...
public class SettingsLayoutFragment extends Fragment implements Layout.LayoutNodeRefreshListener {
    ...
    public static final String EXTRA_ENTRY_TRANSITION_PERFORMED = "entryTransitionPerformed";
    ...
    public static class Builder {
        ...
        private boolean mEntryTransitionPerformed = false;
        ...
        public SettingsLayoutFragment build() {
            ...
            args.putBoolean(EXTRA_ENTRY_TRANSITION_PERFORMED, mEntryTransitionPerformed);
        ...
        public Builder entryAnim(boolean performed) {
            mEntryTransitionPerformed = performed;
            return this;
        }
    }
