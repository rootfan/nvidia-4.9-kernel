...
public class SelectFromListWizardFragment extends Fragment {
    ...
    public void update(List<ListItem> listElements) {
        ...
        mSelectItemRunnable = new Runnable() {
            @Override
            public void run() {
        ...
        mOnListPreDrawListener = new OnPreDrawListener() {
            @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle icicle) {
        ...
        //TODO: boolean forceFocusable = AccessibilityHelper.forceFocusableViews(getActivity());
        if (title != null) {
